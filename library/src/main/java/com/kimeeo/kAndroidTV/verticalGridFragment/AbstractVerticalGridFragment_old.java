...
abstract public class AbstractVerticalGridFragment_old extends VerticalGridFragment implements BackgroundImageHelper.OnUpdate,DataProvider.OnFatchingObserve,MonitorList.OnChangeWatcher {
    ...
    private void setupEventListeners() {
        if(getSearchActivity()!=null)
            setOnSearchClickedListener(new AbstractVerticalGridFragment_old.SearchEventListeners());

        setOnItemViewClickedListener(new AbstractVerticalGridFragment_old.ItemViewClickedListener());
        setOnItemViewSelectedListener(new AbstractVerticalGridFragment_old.ItemViewSelectedListener());
    }
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,RowPresenter.ViewHolder rowViewHolder, Row row) {
            AbstractVerticalGridFragment_old.this.onItemClicked(itemViewHolder,item,rowViewHolder,row);
        }
    }
    private final class ItemViewSelectedListener implements OnItemViewSelectedListener {
        ...
        public void onItemSelected(Presenter.ViewHolder itemViewHolder, Object item,RowPresenter.ViewHolder rowViewHolder, Row row) {
            ...
            AbstractVerticalGridFragment_old.this.onItemSelected(itemViewHolder,item,rowViewHolder,row);
        }
    }
